...
app.get("/api/hehe/vacations", (req, res) => {
...
// 获取图片
app.get("/api/viewPoint/pohots/:id", (req, res) => {
  // 获取单张照片
...
app.post("/api/viewPoint/photo/upload", multipartMiddleware, (req, res) => {
  ...
  fs.readFile(req.files.file.path, (err, data) => {
    ...
    //       }).then(
    //         () => {
    //           console.log("将photo.id插入 ViewPoint表中的imgIds字段success!");
    //         },
    //         () =>
    //           console.log("将photo.id插入 ViewPoint表中的imgIds字段failure!")
    //       );
    //     });
    //   },
    //   () => {
